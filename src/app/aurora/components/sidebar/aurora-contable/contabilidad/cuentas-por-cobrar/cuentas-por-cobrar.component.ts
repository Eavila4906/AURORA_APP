    ...
    this.FacturasServices.get(id).subscribe(
      response => {
        ...
        this.productosEnFactura = response.data.productos.map((producto: any) => ({
          ...
          preciosVenta: [
            { pvpIva0: producto.productos.pvp1Iva0 },
            { pvpIva0: producto.productos.pvp2Iva0 },
            { pvpIva0: producto.productos.pvp3Iva0 },
            { pvpIva0: producto.productos.pvp4Iva0 },
  ...
  public comprobante(data: any, dataAbono: any, op: number) {
    ...
    const docDefinition: any = {
      ...
      content: [
        ...
        { text: `Subtotal (0%): ${data.subtotalSinIva}`, style: 'totales', alignment: 'right' },
